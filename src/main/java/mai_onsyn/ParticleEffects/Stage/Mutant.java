package mai_onsyn.ParticleEffects.Stage;
...
public class Mutant {
    ...
    private static final Timeline timeline = new Timeline("Mutant", Static.path, 65536, 0, "mai_onsyn", "Timeline", "effect");
    private static final PositionTimeline Steve = new PositionTimeline("Steve_path", "Steve", Static.path, "mai_onsyn", "Timeline", "effect");
    private static final PositionTimeline Mutant = new PositionTimeline("Mutant_path", "Mutant", Static.path, "mai_onsyn", "Timeline", "effect");
